...
//
// protected static Type getBoxedType (final Type type)
// {
...
// }
//
// protected static Type getUnboxedType (final Type type)
// {
// for (final Type[] clause : BOXED_PRIMITIVES)
// {
// if (clause[0] == type)
...
// }
//
// public ClassVisitorAdaptor (final int type, final ClassVisitor cv)
// {
// super (type, cv);
// }
//
